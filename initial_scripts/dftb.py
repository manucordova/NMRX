...
def dftbplus_energy(directory, filename, dispersion="D3"):
    """
    ...
    skfdir = root+"/balodis/dft_b/dftbplus-19.1/pseudo/"
    ...
    os.chdir(directory+number+"tmp")
    if not cluster:
        process = sp.Popen("/Users/balodis/dft_b/dftbplus-19.1/_install/bin/dftb+", stdout=sp.PIPE)
    else:
        process = sp.Popen("/home/balodis/dftbplus-19.1.x86_64-linux/bin/dftb+", stdout=sp.PIPE)
    ...
    shutil.rmtree(directory+number+"tmp")
