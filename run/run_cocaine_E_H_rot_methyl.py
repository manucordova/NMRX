...
out_dir = "../data/cocaine_rot_methyl/"
...
if molecule == "cocaine":
    ...
    conf_params = {}
    conf_params["a1"] = [13, 19, 7, 2, 1, 40, 37]
    conf_params["a2"] = [8, 7, 18, 1, 14, 16, 15]
    conf_params["a3"] = [7, 18, 2, 14, 21, 17, 21]
    conf_params["a4"] = [18, 2, 3, 20, 15, 0, 14]
    conf_params["mask"] = [[9, 10, 11, 12, 13, 32, 33, 34, 35, 36], [8, 9, 10, 11, 12, 13, 19, 32, 33, 34, 35, 36], [7, 8, 9, 10, 11, 12, 13, 19, 32, 33, 34, 35, 36], [15, 20, 21, 37, 38, 39], [15, 37, 38, 39], [40, 41, 42], [37, 38, 39]]
