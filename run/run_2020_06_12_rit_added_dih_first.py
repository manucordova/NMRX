...
import generate_crystals_cartesian_dih_first as cr
...
step_list = [2.0, 2.0, 2.0, 20.0, 20.0, 20.0, 2.0, 360.0, 180.0]
...
for k in range(structures):
    ...
    trial_crystal, lat, trans, rotation, starting_angles, n_failed = cr.generate_crystal(starting, parameter_set,
                                                                                     ...
                                                                                     vol_high,old_overlap=True,smart_cell = True)
            ...
            while True:
                try:
                    ...
                    if parameter == 'rot':
                        ...
                        trial_rotation[0] = random.random() * step_list[7]
                        trial_rotation[1] = random.random() * step_list[7]
                        trial_rotation[2] = random.random() * step_list[7]
