...
comment = "production_run_cstr"
# Directory for results
out_dir = "../data/cocaine_production_09_2020_cstr/"
...
if molecule == "cocaine":
    ...
    constraints = {}
    constraints["n_tol"] = 0
    constraints["pairs"] = [[14, 32], [14, 33], [14, 34], [14, 35], [14, 36]]
    constraints["thresh"] = 3.5
    constraints["contact"] = False
...
for k in range(n_structures):
    ...
    best_crystal, lat, trans, R, conf_angles = cr.generate_crystal(starting_structure, n_atoms, n_mol, sg, parameter_set, cell_params_lims, n_conf=n_conf, conf_params=conf_params, smart_cell=smart_cell, max_V_factor=max_V_factor, constraints=constraints, verbose=verbose)
