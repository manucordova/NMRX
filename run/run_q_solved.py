...
for k in range(structures):
    starting = copy.deepcopy(starting_structure)
    trial_crystal, lat, trans, quat, starting_angles, n_failed = cr.generate_crystal(starting, parameter_set, high_angle, low_angle, high_trans, low_trans, rotate_high, rotate_low, sg, atoms, nr_molecules[choice], molecule, cut, close_atoms, vol_high)
...
##
        ...
        while True:
            while True:
                try:
                    ...
                    trial_structure = cr.create_crystal(starting_copy, molecule, sg, atoms, sites, trial_lat, trial_trans, trial_quat, trial_angles, nr_molecules[choice])
    ...
    final_structure = cr.create_crystal(starting_copy, molecule, sg, atoms, sites, lat, trans, quat, final_angles, nr_molecules[choice])
    ...
    if simplex:
        ...
        def optimisation_function(guess, constants, guess_names, constants_names, all_param_names, starting, sg, atoms, sites, H1, use_energy, factor, krr, representation, trainsoaps, model_numbers,
            ...
            trial_structure = cr.create_crystal(starting_copy, molecule, sg, atoms, sites, lat, trans, quat, conf_angles, nr_molecules[choice])
        ...
        res = op.minimize(optimisation_function, guess, args=(constants, guess_names, constants_names, all_param_names, starting, sg, atoms, sites,H1, use_energy, factor, krr, representation, trainsoaps, model_numbers,
