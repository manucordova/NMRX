...
gas_cst = 8.314e-3
# Simplex optimization at the end of the MC run
simplex = True
...
# Copy structure
initial_structure_file = out_dir + name + "/{}.pdb".format(random_number)
shutil.copyfile(initial_structure_original, initial_structure_file)
# Load initial structure
initial_structure = ase.io.read(initial_structure_file)
