...
out_dir = "../data/cocaine_production_09_2020_simplex/"
...
for k in range(n_structures):
    ...
    if opt:
        ...
        start = time.time()
        opt_crystal, opt_lat, opt_trans, opt_R, opt_conf = mc.simplex_opt(starting_structure, opt_lat, opt_trans, opt_R, opt_conf, sg, n_atoms, parameter_set, cost_function, cost_factors, cost_options, cell_params_lims, conf_params=conf_params, verbose=verbose)
        stop = time.time()
