...
for k in range(structures):
    ...
    trial_crystal, lat, trans, quat, starting_angles, n_failed = cr.generate_crystal(starting, parameter_set,
                                                                                     ...
                                                                                     low_trans, rotate_high, rotate_low,
    ...
    if use_energy:
        np.save(directory + name + '/' + experiment + "_" + str(k) + '_energies.npy', all_energies)
    if H1:
        np.save(directory + name + '/' + experiment + "_" + str(k) + '_1H_chis.npy', all_chi_H)
    if C13:
        np.save(directory + name + '/' + experiment + "_" + str(k) + '_13C_chis.npy', all_chi_C)
